...
nearmiss_xgb_pred <- ifelse(nearmiss_xgb_pred > 0.5, 1, 0) #used 0.9 as per threshold optimisation below
...
smote_xgb_pred <- ifelse(smote_xgb_pred > 0.5, 1, 0) #used 0.9 as per threshold optimisation below
...
tomek_xgb_pred <- ifelse(tomek_xgb_pred > 0.5, 1, 0) #used 0.9 as per threshold optimisation below
